...
public class VehicleScreen extends HandledScreen<VehicleScreenHandler> {
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        if (vehicle != null) {
            ...
            int statX = 110;
            // Para el tractor subimos el inicio de las stats a 30 para dejar hueco al remolque abajo
            ...
            // --- 3. Grip (Agarre) ---
            float gripPct = MathHelper.clamp(vehicle.getForwardSpeed() > 0 ? 0.8f : 0.5f, 0, 1);
            ...
            int hpBarColor = destroyed ? 0xFF333333 : (pct > 0.5f ? 0xFF44CC44 : (pct > 0.25f ? 0xFFFFCC00 : 0xFFEE2222));
